...
Class['mysql::datadir'] -> Class['percona::repository'] -> Class['percona::server'] -> Class['percona::config'] -> Class['percona::service'] -> Class['misc::innotop'] -> Class ['misc::sakila'] -> Class ['misc::sakila::install'] -> Class ['test::imdb'] -> Class['training::imdb::workload'] -> Class['training::imdb::erase_perconaserverinstall']
